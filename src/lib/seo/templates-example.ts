...
export const categoryPageTemplate = (category: {
  ...
  description: category.description || `Play free online ${category.name.toLowerCase()} games. No download, no login required. Enjoy the best ${category.name.toLowerCase()} games collection.`,
  alternates: {
  ...
  openGraph: {
    ...
    images: [
      {
        url: category.imageUrl ? `${baseUrl}${category.imageUrl}` : `${baseUrl}/images/categories/${category.id}.jpg`,
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: `${category.name} Games | Free Online ${category.name} Games`,
    description: category.description || `Play free online ${category.name.toLowerCase()} games. No download, no login required. Enjoy the best ${category.name.toLowerCase()} games collection.`,
    images: [category.imageUrl ? `${baseUrl}${category.imageUrl}` : `${baseUrl}/images/categories/${category.id}.jpg`],
    creator: '@nologingames',
  },
});
